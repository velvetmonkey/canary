...
date: '2026-03-12'
created: '2026-03-12T17:26:26.394Z'
---
...
**What:** For each financial product with sustainable investment as its objective, include in pre-contractual disclosures: how the designated index is aligned with that objective and why it differs from a broad market index (if benchmark used); or how the objective is to be attained (if no benchmark); or, for carbon-emission-reduction products, the low-carbon exposure objective in view of [[Paris Agreement]] goals.
