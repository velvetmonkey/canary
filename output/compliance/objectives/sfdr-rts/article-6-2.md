...
**What:** Describe in the PAI statement the actions taken during the preceding reference period AND the actions planned or targets set for the subsequent reference period to avoid or reduce the principal adverse impacts identified.
**Where:** In the PAI statement (Table 1, Annex I), 'Description of the principal adverse impacts on sustainability factors' section
