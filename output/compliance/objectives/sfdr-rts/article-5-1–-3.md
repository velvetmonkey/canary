...
**What:** The summary section of the PAI statement must be drafted in: (a) one official language of the home Member State and, where different, in an additional language customary in international finance (e.g. English); and (b) one official language of any host Member State where the financial product is made available. The summary must not exceed two sides of A4 paper when printed.
**Where:** In the PAI statement on the website (Table 1, Annex I), summary section
**Materiality:** medium
