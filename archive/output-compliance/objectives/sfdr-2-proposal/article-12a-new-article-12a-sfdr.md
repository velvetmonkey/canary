...
article: Article 12a (new Article 12a SFDR)
...
**What:** Must: (a) ensure use of external data providers is based on formalised and documented arrangements; (b) ensure use of in-house estimates is based on formalised and documented methodologies; and (c) provide clients upon request with information on data providers (name, contact details, methodology) and on in-house estimation methodologies, main assumptions and treatment of missing data points.
